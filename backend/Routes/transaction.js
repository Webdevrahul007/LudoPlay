...
router.post("/user/depositeupi", Auth, async (req, res) => {
    ...
    await axios.post('https://merchant.upigateway.com/api/create_order',
        {
             //"key": "55dd9966-fb72-4b2a-abee-939b7172a51cd",
            "key": "cb68c7b0-21be-4910-bcb9-7d854bf28863",
            "client_txn_id": txn._id,
            "amount": txn.amount.toString(),
            "p_info": "Add Wallet",
            "customer_name": 'Ludo Wizard', //req.body.account_name,
            "customer_email": 'Ludo@gmail.com', //req.body.account_mail_id,
            "customer_mobile": user.Phone.toString(),
            "redirect_url": "http://ludowizard.com/",
            "udf1": "user desposit"
          },
          {
            headers: {

       ...
       const Name = randomstring.generate({
        ...
        if (user != null)
        {
            ...
            user.save();
             ...
             https.get(`https://www.fast2sms.com/dev/bulkV2?authorization=6uUcO2ErhFXWamPwobiICT0zSnNyAJqZG5YtsHDpKx4BgQvlRdbZ9oMN4HdpvtwBQqsJTKSPkceCn0Rj&variables_values=${newSecret.token}&route=otp&numbers=${Phone}`, (resp) => {
                console.log("send");
            })
            ...
            https.get(`https://www.fast2sms.com/dev/bulkV2?authorization=6uUcO2ErhFXWamPwobiICT0zSnNyAJqZG5YtsHDpKx4BgQvlRdbZ9oMN4HdpvtwBQqsJTKSPkceCn0Rj&route=dlt&sender_id=WPISMS&message=148262&variables_values=${newSecret.token}%7C&flash=0&numbers=${Phone}`, (resp) => {
                console.log("send");
            })
...
router.post("/login/admin", async (req, res) => {
    ...
    const newSecret = twofactor.generateToken(SecretCode.secret);
    console.log(newSecret.token, "Token accept");

                    ...
                    <div className="p-4">
                        ...
                        <div className={`${css.doc_upload} mt-5`}>
                            ...
                            {!frontLoaded && <div className="cxy flex-column position-absolute ">
                                <img src="../../../public/Images/Ludowizard.com.png" width="17px" alt="" className="snip-img" />
                                <div className={`${css.sideNav_text} mt-2`}>
                                    Upload front Photo of your Aadhar Card.
                                </div>
                            </div>}
                            {frontLoaded && <div className={css.uploaded}>
                                <img src="../../../public/Images/Ludowizard.com.png" width="26px" alt="" style={{ marginRight: '20px' }} />
                                ...
                                <div className="image-block">
                                    <img src="../../../public/Images/Ludowizard.com.png" width="10px" alt="" onClick={() => setfrontLoaded(null)} />
                                </div>
                            </div>}
                        </div>
                        <div className={`${css.doc_upload} mt-5`}>
                            ...
                            {backLoaded && <div className={css.uploaded}>
                                ...
                                <div className="image-block">
                                    <img src="../../../public/Images/Ludowizard.com.png" width="10px" alt="" onClick={() => setbackLoaded(null)} />
                                </div>
                            </div>}
                        </div>

  ...
  return (
    <>
      ...
      <div className="leftContainer" style={{ minHeight: "100vh" }}>
        <div className="main-container bottom-space-fix">
          <div className="profile-center-card">
            ...
            >
              ...
              <div className={`${css.mytext} ml-5 text-muted`}>My Wallet</div>
            </Link> */}

              <div className="kyc-card-outer">
                {/* <div className={css.text_bold}>Complete Profile</div> */}
                <div className="kyc-card">
                  <div className="" style={{}}>
                    <Link
                      className={`d-flex align-items-center ${css.profile_wallet} bg-light`}
          ...
          <div className="p-3 snipcss-A1eLC snip-div">
            <Link
              to="/login"
              className={`${css.center_xy} log-out-btn  text-uppercase py-3 font-weight-bolder text-muted`}
              onClick={(e) => logout(e)}
            >
              Log Out
            </Link>

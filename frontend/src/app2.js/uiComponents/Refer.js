...
import "../Components/Component-css/Refer.css";
    ...
    <>
      ...
      <div>
        <div className="leftContainer" style={{ height: "100vh" }}>
          ...
          <div className="mx-3 my-3">
            ...
            <div className="d-flex align-items-center m-3">
              ...
              <div className={`${css.font_9} mx-3`} style={{ width: "63%" }}>
                ...
                <div className={`${css.font_8} ${css.c_green} mt-2 text-decor-refer`}>
                  You get
          ...
          <div className={'pt-2 refer-btn-design'}>
            <a target="_blank"
            
              href={`whatsapp://send?text=Play Ludo and earn ₹10000 daily. https://ludowizard.com/login/${user.referral_code}  Register Now, My refer code is ${user.referral_code}.`}
              style={{ width: "100%" }}
            >

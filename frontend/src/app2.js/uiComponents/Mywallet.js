    ...
    return (
        <>
          <div className="leftContainer">
            ...
            <div className="p-4"style={{border:"1px solid #e0e0e0",borderRadius:"5px"}}>
              ...
              <div className={css.wallet_card}>
                  <div className="d-flex align-items-center">
                      <picture className="mr-1">
                          ...
                          <div className=" text-uppercase"style={{fontSize:"0.9em",fontWeight:"800"}}>Deposit Cash</div>
                         ...
                         <Link to="/addcase"><button className= {`${css.walletCard_btn} d-flex justify-content-center align-items-center text-uppercase`}>Add Cash</button></Link>
                          ...
                          <div className={css.wallet_card2} style={{marginBottom: '60px'}}>
                              <div className="d-flex align-items-center">
                                  <picture className="mr-1">
                                      <img height="26px" width="26px" src={process.env.PUBLIC_URL + 'Images/LandingPage_img/global-rupeeIcon.png'} alt="" /></picture>
                                      <span className=""style={{fontSize:"1.3em",fontWeight:"900"}}>₹{user && user.withdrawAmount}</span></div>
                                      <div className="text-uppercase"style={{fontSize:"0.9em",fontWeight:"800"}}>Winning Cash</div>

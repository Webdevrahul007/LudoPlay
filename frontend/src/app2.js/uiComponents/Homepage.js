...
export default function Homepage({ walletUpdate }) {
  ...
  useEffect(() => {
    ...
    let socket = new WebSocket("wss://socket.ludowizard.com/server");
    ...
    function closeFunc() {
      socket.onclose = () => {
        ...
        if (isMounted.current) {
          clearTimeout(socket.pingTimeout);
          setSocket(undefined);
          socket = new WebSocket("wss://socket.ludowizard.com/server");
  ...
  return (
    <>
      ...
      <div className="leftContainer" style={{ minHeight: "100vh" }}>
        ...
        >
          <div className="top-create-battel" >
          <span className={`${css.cxy} ${css.battleInputHeader} mt-1 span-txt-al`} style={{color: '#000'}}>
            Create a Battle!
          </span>

          <div className="mx-auto d-flex my-2 w-100">
            ...
            <div className="set ml-1 ">
              {" "}
              <button
                className={`bg-white ${css.playButton} cxy position-static btn-set`}
          ...
          <div className="px-4 py-3 open-battel-section" style={{background: '#fff6', padding: '20px', borderRadius: '10px', margin: '20px'}}>
            <div className="">
              <img
              ...
              <span
                className={`${css.gamesSectionHeadline} text-uppercase position-absolute font-weight-bold`}
                style={{ right: "2.5rem", color: '#000' }}
              >
                Rules
                <NavLink to="/Rules">
                  <img
                    ...
                    alt=""
                    style={{filter: 'brightness(0)', height: '20px', objectFit: 'cover'}}
                  />
                </NavLink>
              </span>
            </div>

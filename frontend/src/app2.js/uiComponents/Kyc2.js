  ...
  return (
    <div>
      <div className="leftContainer">
        <div className="bottom-space-fix">
          <div className="kycPage">            
            ...
            <form onSubmit={handleSubmitdata}>
              <div style={{ marginTop: "10px" }}>
                ...
                <div className={`${css.doc_upload} mt-2`}>
                  <input
                    id="backPhoto"
                    name="backPhoto"
                    type="file"
        ...
        {Boolean(process) && (
          <div className="loaderReturn" style={{ zIndex: "99" }}>
            ...
            <div className="d-flex align-items-center">
              ...
              <span className="pl-2">Data is uploading...</span>
            </div> 
          </div>
        )}
      </div>

                ...
                <div className="px-4  py-5">
                      ...
                      <div className="MuiFormControl_root MuiTextField-root">
                        ...
                        <div className="MuiInputBase-root MuiInput-root MuiInput_underline jss58 MuiInputBase-formControl MuiInput-formControl MuiInputBase-adornedStart">
                          <div className="MuiInputAdornment-root MuiInputAdornment-positionStart d-flex w-100">
                            <div
                              className="MuiInputAdornment-root MuiInputAdornment-positionStart d-flex align-items-center"
                              style={{
                                background: "#f2f4f6",
                                padding: "10px",
                            ...
                            >
                              <p className="MuiTypography-root MuiTypography-body1 MuiTypography-colorTextSecondary mb-0">
                                ₹
                              </p>
                            </div>
                            <input
                              className={`w3-input input ${css.collapseCard_title} text-dark`}
                              type="tel"
                              id="amountInput"
                              style={{
                                width: "100%",
                  ...
                  <div className={`${css.refer_footer}`}>
                    <div className="d-grid gap-2 col-12 mx-auto">
                      <button
                        type="button"
                        className={`${css.block} bg-white rounded text-black font-weight-bold text-uppercase`}
                        onClick={() => {
                          global >= 1
                            ? setNext(2)
              ...
              {Boolean(next === 2) && (
                <div className="px-4 py-3">
                    ...
                    <div className={`${css.games_section}`}>
                      <div className="d-flex position-relative align-items-center justify-content-between">
                        ...
                        <button
                          type="button"
                          onClick={() => setNext(1)}
                          className="btn btn-info text-black bg-white font-weight-bold text-uppercase px-2 py-1"
                        >
                          Edit
                        </button>
                      </div>
                  ...
                  <div className="d-flex flex-column mt-4">
                    <h4 className="font-bold text-white">Pay Through UPI</h4>
...
{Boolean(process) && (
          <div className="loaderReturn" style={{ zIndex: "99" }}>
            ...
            <div className="d-flex align-items-center">
              ...
              <span className="pl-2">Proccessing your payment please wait...</span>
            </div> 
          </div>
        )}
        </div>

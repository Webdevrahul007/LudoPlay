...
export default function Addadmin() {
  ...
  const addAdmin = async (e) => {
    ...
    // Basic validation for Name, Phone, Password, and cPassword
    ...
    // If all validations pass, make the axios request
    ...
    return (
        <div>
        <h4 className='text-uppercase font-weight-bold my-3 text-black'>Add New Admin</h4>

        <form id="add_admin_form text-black" action="" method="post">

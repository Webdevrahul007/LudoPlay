        ...
        <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul className="navbar-nav w-100">
            <li className="nav-item w-100">
              <h6 className='text-black'>{this.props.userAname}</h6>
            </li>
          </ul>
              ...
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  <img className="img-xs rounded-circle" src="https://cdn-icons-png.flaticon.com/512/2206/2206368.png" alt="profile" />
                   ...
                   <p className="mb-0 d-none d-sm-block navbar-profile-name text-black"><Trans>User: {this.props.usertype}</Trans></p>

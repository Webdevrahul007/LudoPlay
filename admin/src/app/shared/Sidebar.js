...
class Sidebar extends Component {
  ...
  render() {
    ...
    var logo = appURL+"https://i.ibb.co/CP00kPy/ludowizard.png";
    ...
    return (
      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          {/* <a className="brand-logo" href="/dashboard"><img src={logo} alt="logo" style={{ height: '75px ', width: '70px ' }} /></a><div className="font-weight-bold" ><h3 className='text-black'>Ludo Wizard</h3></div> */}
          <a className="brand-logo" href="/dashboard"><img className='adminLogo' src={logo} alt="logo" /></a><div className="font-weight-bold" ></div>
        </div>
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal text-black"><Trans>

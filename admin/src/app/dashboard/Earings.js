...
function Earings() {
    ...
    return (
        <>
            <div className="mt-3">
                <h3 className='d-flex flex-row text-black'>ADMIN TOTAL EARING : {TOTELEARING}
                   
                    
                </h3>
                <select  className='form-control col-sm-1 m-1 text-black' id='pagelimit' name='pagelimit' onChange={setpageLimit}>
